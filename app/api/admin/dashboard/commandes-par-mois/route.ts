...
export async function GET() {
  try {
    ...
    const commandesParMois = commandes.reduce((acc: { [key: string]: number }, commande) => {
      const mois = commande.date.toLocaleString("fr-FR", { month: "long", year: "numeric" }); // Use French locale
    ...
    console.log("API (Commandes): Chart Data:", chartData);
